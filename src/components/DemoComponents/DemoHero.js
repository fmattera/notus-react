          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Upload a picture of your living room!
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400">
                      <i className="fas fa-solid fa-crop-simple"></i>
                      {/* <i class="fa-solid fa-crop-simple"></i> */}
                    </div>
                    <h6 className="text-xl font-semibold">2.</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Crop the picture and select the product.
                    </p>
                  </div>
                </div>
              </div>
